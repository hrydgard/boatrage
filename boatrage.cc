...
*****************************************************************************
*Emailware by Zenon (Henrik Rydgård)                                        *
...
#include "view.h"     //The View class which draws stuff
#include "menu.h"     //The CoolMenu function (used for the main menus)
#include "mapedit.h"  //The Editor
#include "menumagm.h"
...
int main(int argc, const char *argv[]) {
 ...
 draw_rle_sprite(display,(RLE_SPRITE *)d(ZENONPRESENTERAR),SCR_X,SCR_Y);
 display.flip();
 //...fade in...
 display.fadein(3);
 //...wait...
