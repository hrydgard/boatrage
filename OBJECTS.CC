...
void boat::move() {
 #define ir(i) (i&0xffff0000) //avrunda ner till närmaste heltal
 #define iru(i) (((i>>16)+1)<<16) //avrunda upp till närmaste heltal
 ...
 //kolla om den har kört upp på land eller nåt sånt
...
/* // JAG HAR SLÄNGT VAPENFUNKTIONERNA. DE PASSADE INTE IN I SPELBALANSEN...
